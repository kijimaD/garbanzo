...
func newEvent(notificationID string, userName string, avatarURL string, title string, body string, HTMLURL string, ProxyURL string, repoName string, when string, kind string, updatedAt time.Time) *Event {
	return &Event{
